...
let s:colors = {
      ...
      \ "comment_grey": get(s:overrides, "comment_grey", { "gui": "#8B8970", "cterm": "59", "cterm16": "15" }),
      \ "gutter_fg_grey": get(s:overrides, "gutter_fg_grey", { "gui": "#8B7B8B", "cterm": "238", "cterm16": "15" }),
      \ "cursor_grey": get(s:overrides, "cursor_grey", { "gui": "#2C323C", "cterm": "236", "cterm16": "8" }),
      \ "visual_grey": get(s:overrides, "visual_grey", { "gui": "#666666", "cterm": "237", "cterm16": "15" }),
